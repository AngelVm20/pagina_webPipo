...
import imgEco200 from "./assets/navidad/ecofastnavidad.png";
import imgSmart300 from "./assets/navidad/smartfastnavidad.png";
import imgPower4002 from "./assets/navidad/powerfastnavidad.png";
import imgPlay500 from "./assets/navidad/playfastnavidad.png";
...
import familiafast from "./assets/navidad/familiafastnavidad.png";
...
const PICHINCHA_APP_IOS =
  "https://apps.apple.com/ec/app/pichincha-banca-movil/id999191728";
const PICHINCHA_APP_ANDROID =
  "https://play.google.com/store/apps/details?id=com.yellowpepper.pichincha";
...
function PaySection() {
  return (
    <>
      <h2>PAGA AQUÍ</h2>
      <p className="muted">
        Te llevamos a la Banca Web o a la app móvil de Banco Pichincha para que
        realices tu pago de forma segura.
      </p>
...
function Splash() {
  ...
  return (
    ...
    >
      {/* LUCES NAVIDEÑAS ENCIMA DEL SPLASH */}
      <div className="splash-lights-container">
        <NavidadLights />
      </div>
...
function NavidadLights() {
  return (
    <div className="xmas-lights" aria-hidden="true">
      {Array.from({ length: 18 }).map((_, i) => (
        <span key={i} className="xmas-bulb" />
      ))}
    </div>
  );
}
...
function MapsSection() {
  const iframeSrc = useMemo(
    () => mapsEmbed(MAP_LAT, MAP_LNG, MAP_PLACE),
    []
  );
...
export default function App() {
  ...
  useEffect(() => {
    ...
    return () => document.body.classList.remove("navidad");
  }, []);
  ...
  return (
    <>
      ...
      <main className="container">
        {/* PLANES */}
        <section className="section section--panel" id="planes">
        ...
        <section className="section section--panel">
          ...
          <div className="promos">
            <img
              src={sonrisas}
              alt="Promoción sonrisas"
              loading="lazy"
              decoding="async"
            />
            <img
              src={scooter}
              alt="Promoción scooter"
              loading="lazy"
              decoding="async"
            />
            <img
        ...
        <section className="section section--panel">
          <h2>BENEFICIOS</h2>
          <div className="promos">
            <img src={tri} alt="Beneficios" loading="lazy" decoding="async" />
            <img
              src={soporte}
              alt="soporte 24/7"
              loading="lazy"
        ...
        {/* PAGO */}
        <section className="section section--panel" id="paga-aqui">
          <PaySection />
        </section>

        {/* VIDEO PAGO */}
        <section className="section section--panel" id="guia-de-pago">
          <PayGuideVideo />
        </section>
